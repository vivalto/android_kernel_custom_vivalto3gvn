...
//before apply samsung battery# if defined(CONFIG_BATTERY_SAMSUNG)
...
static struct stc311x_platform_data stc3117_data = {
		...
		.CC_cnf = 294,      /* nominal CC_cnf, coming from battery characterisation*/
		.VM_cnf = 487,      /* nominal VM cnf , coming from battery characterisation*/
		.Rint = 327,			/* nominal internal impedance*/
	...
	.OCVValue[15] = 4300,            /* OCV curve adjustment */
	.OCVValue[14] = 4172,            /* OCV curve adjustment */
	.OCVValue[13] = 4076,            /* OCV curve adjustment */
	.OCVValue[12] = 3989,            /* OCV curve adjustment */
	.OCVValue[11] = 3950,            /* OCV curve adjustment */
	.OCVValue[10] = 3899,            /* OCV curve adjustment */
	.OCVValue[9] = 3821,             /* OCV curve adjustment */
	.OCVValue[8] = 3785,             /* OCV curve adjustment */
	.OCVValue[7] = 3763,             /* OCV curve adjustment */
	.OCVValue[6] = 3752,             /* OCV curve adjustment */
	.OCVValue[5] = 3732,             /* OCV curve adjustment */
	.OCVValue[4] = 3692,             /* OCV curve adjustment */
	.OCVValue[3] = 3657,             /* OCV curve adjustment */
	.OCVValue[2] = 3636,             /* OCV curve adjustment */
	.OCVValue[1] = 3560,             /* OCV curve adjustment */
